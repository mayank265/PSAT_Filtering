...
def useful_values():
    ...
    U_mean=round(data['U'].mean(),8)
    V_mean=round(data['V'].mean(),8)
    W_mean=round(data['W'].mean(),8)

    data.at[index,'U_mean']=U_mean
    data.at[index,'V_mean']=V_mean
    data.at[index,'W_mean']=W_mean

    data['u\'']=round(data['U']-U_mean,8)
    data['v\'']=round(data['V']-V_mean,8)
    data['w\'']=round(data['W']-W_mean,8)
    N=data['U'].count()
    ...
    print("K=",(round(data['u\'u\''].mean(),8)+round(data['v\'v\''].mean(),8)+round(data['w\'w\''].mean(),8))/2)
    print("TI=",math.sqrt((round(data['u\'u\''].mean(),8)+round(data['v\'v\''].mean(),8)+round(data['w\'w\''].mean(),8))/3)) 
    
    data.at[0,'K'] = (round(data['u\'u\''].mean(),8)+round(data['v\'v\''].mean(),8)+round(data['w\'w\''].mean(),8))/2
    TI = math.sqrt((round(data['u\'u\''].mean(),8)+round(data['v\'v\''].mean(),8)+round(data['w\'w\''].mean(),8))/3)
    TI = round(TI,8)
    print("TI = ", TI)
    data.at[0,'TI']=TI
...
def fk():
    ...
    data.at[index,'fku_2d']=round((data.at[0,'u\'u\'u\' mean']+data.at[0,'u\'w\'w\' mean'])*constant_fk2d,8)
    data.at[index,'Fku_2d']=round(data.at[index,'fku_2d']/Shear_velocity,8)

    data.at[index,'fkw_2d']=round((data.at[0,'w\'w\'w\' mean']+data.at[0,'w\'u\'u\' mean'])*constant_fk2d,8)
    ...
    data.at[index,'fku_3d']=round((data.at[0,'u\'u\'u\' mean']+ data.at[0,'u\'w\'w\' mean'] + data.at[0,'u\'v\'v\' mean'] )*multiplying_factor_3d,8)
    data.at[index,'Fku_3d']=round(data.at[index,'fku_2d']/Shear_velocity,8)

    data.at[index,'fkw_3d']=round((data.at[0,'w\'w\'w\' mean']+data.at[0,'w\'u\'u\' mean'] + data.at[0,'w\'v\'v\' mean'])*multiplying_factor_3d,8)
    data.at[index,'Fkw_3d']=round(data.at[index,'fkw_3d']/Shear_velocity,8)

    data.at[index,'TKE_3D']=round((data.at[0,'Var_v\'']*data.at[0,'Var_u\'']*data.at[0,'Var_w\''])* multiplying_factor_3d,8)
...
def octant():
    ...
    data.at[index,'Probability_Octant_plus_1']=round(octant_values_frequency[1+4]/N,8)
    max_min_update(octant_values_frequency[1+4],1)

    #for id -1
    data.at[index,'Octant_minus_1']=octant_values_frequency[-1+4]
    data.at[index,'Probability_Octant_minus_1']=round(octant_values_frequency[-1+4]/N,8)
    max_min_update(octant_values_frequency[-1+4],-1)

    #for id 2
    data.at[index,'Octant_plus_2']=octant_values_frequency[2+4]
    data.at[index,'Probability_Octant_plus_2']=round(octant_values_frequency[2+4]/N,8)
    max_min_update(octant_values_frequency[2+4],2)

    #for id -2
    data.at[index,'Octant_minus_2']=octant_values_frequency[-2+4]
    data.at[index,'Probability_Octant_minus_2']=round(octant_values_frequency[-2+4]/N,8)
    max_min_update(octant_values_frequency[-2+4],-2)

    #for id 3
    data.at[index,'Octant_plus_3']=octant_values_frequency[3+4]
    data.at[index,'Probability_Octant_plus_3']=round(octant_values_frequency[3+4]/N,8)
    max_min_update(octant_values_frequency[3+4],8)

    #for id -3
    data.at[index,'Octant_minus_3']=octant_values_frequency[-3+4]
    data.at[index,'Probability_Octant_minus_3']=round(octant_values_frequency[-3+4]/N,8)
    max_min_update(octant_values_frequency[-3+4],-3)

    #for id 4
    data.at[index,'Octant_plus_4']=octant_values_frequency[4+4]
    data.at[index,'Probability_Octant_plus_4']=round(octant_values_frequency[4+4]/N,8)
    max_min_update(octant_values_frequency[4+4],4)

    #for id -4
    count_i=0
    data.at[index,'Octant_minus_4']=octant_values_frequency[-4+4]
    data.at[index,'Probability_Octant_minus_4']=round(octant_values_frequency[-4+4]/N,8)
    max_min_update(octant_values_frequency[-4+4],-4)
...
def add_front_name(name,x):
    ...
    return name
print("-"*25)
print('0. None','1. C','2. S','3. A','4. C & S','5. C & A','6. S & A','7. C & S & A','8. all combine',sep='\n')
...
print('0. None','1. previous point','2. 2*last-2nd_last','3. overall_mean',
